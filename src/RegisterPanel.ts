...
class RegisterPanel extends GameUtil.BassPanel
{
    ...
    private showpanel():void
    {
        ...
        var text:string[] = ['手机号','验证码','密    码'];
        var inputframe:GameUtil.InputTextFiled[] = [this.inputphoneframe,this.inputcodeframe,this.inputpswframe];
